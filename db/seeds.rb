...
Post.create(dog_name: "Champ", vote_count: 31, image_url: "http://stories.barkpost.com/wp-content/uploads/2014/04/dog-star-wars-costume-12.jpg", description: "You were my brother! I loved you!", user: fryguy, theme: starwars)
...
Post.create(dog_name: "King", vote_count: 22, image_url: "http://i1.mirror.co.uk/incoming/article6965338.ece/ALTERNATES/s615b/PAY-Storm-Trooper-Dog.jpg", description: "I even miss when I go pee-pees", user: misty, theme: starwars)
